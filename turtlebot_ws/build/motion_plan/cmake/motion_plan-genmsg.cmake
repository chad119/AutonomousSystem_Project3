...
message(STATUS "motion_plan: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imotion_plan:/home/chadchiang/turtlebot_ws/src/motion_plan/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chadchiang/turtlebot_ws/src/motion_plan/msg/reference_point.msg" NAME_WE)
add_custom_target(_motion_plan_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motion_plan" "/home/chadchiang/turtlebot_ws/src/motion_plan/msg/reference_point.msg" ""
)
...
_generate_msg_cpp(motion_plan
  "/home/chadchiang/turtlebot_ws/src/motion_plan/msg/reference_point.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(TARGET std_msgs_generate_messages_cpp)
  add_dependencies(motion_plan_generate_messages_cpp std_msgs_generate_messages_cpp)
endif()
...
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(motion_plan_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(TARGET std_msgs_generate_messages_lisp)
  add_dependencies(motion_plan_generate_messages_lisp std_msgs_generate_messages_lisp)
endif()
...
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(motion_plan_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motion_plan)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motion_plan\")")
  # install generated code
  install(
...
if(TARGET std_msgs_generate_messages_py)
  add_dependencies(motion_plan_generate_messages_py std_msgs_generate_messages_py)
endif()
