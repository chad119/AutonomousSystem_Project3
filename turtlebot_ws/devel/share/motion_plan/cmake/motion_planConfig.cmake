...
if("TRUE" STREQUAL "TRUE")
  set(motion_plan_SOURCE_PREFIX /home/chadchiang/turtlebot_ws/src/motion_plan)
  set(motion_plan_DEVEL_PREFIX /home/chadchiang/turtlebot_ws/devel)
  ...
  set(motion_plan_INSTALL_PREFIX /home/chadchiang/turtlebot_ws/install)
...
if(NOT "/home/chadchiang/turtlebot_ws/devel/include " STREQUAL " ")
  set(motion_plan_INCLUDE_DIRS "")
  set(_include_dirs "/home/chadchiang/turtlebot_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chadchiang/turtlebot_ws/src/motion_plan/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;turtlebot3_gazebo;turtlebot3_navigation;turtlebot3_slam;message_runtime")
